...
// Carpetas de destino (Railway compatible)
const SUBTITLED_VIDEOS_DIR = STORAGE_CONFIG.videosSubtitled;
const TMP_SUBTITLES_DIR = isRailway ? '/tmp/subtitles' : 'tmp_subtitles';
...
/**
 * Obtener lista de videos con subtítulos (Railway compatible)
 */
    ...
    for (const file of files) {
      if (file.toLowerCase().endsWith('.mp4')) {
        ...
        const videoPath = isRailway 
          ? `/api/temp/videos_subtitled/${file}`
          : `/final_videos_subtitled/${file}`;
